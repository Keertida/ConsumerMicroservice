...
namespace ConsumerMicroservice.Controllers
{
    ...
    public class ConsumerController : ControllerBase
    {
        ...
        public ActionResult GetProperties(int PropertyId, int ConsumerId)
        {
            var obj = _consumerService.GetProperties(PropertyId,ConsumerId);
            return Ok(obj);
        }

        // Display of consumer by ID
        //[Authorize(AuthenticationSchemes = "Bearer")]
        [HttpGet("GetConsumerById/{ConsumerId}")]
