...
namespace ConsumerMicroservice.RepositoryLayer
{
    public class BusinessPropertyRepository : IBusinessPropertyRepository
    {
        ...
        // GEt property by Id
        public Property GetProperties(int PropertyId,int ConsumerId)
        {
        ...
        public bool CreateProperty(Property property)
        {
            try
            {
                property.PropertyValue = (property.CostOfAssest - property.SalvageValue) / property.UsefulLifeOfAssest;
            }
            catch (Exception e)
            {
